            ...
            items: [
                ...
                "frontend/app-components-component-groups",
                {
                    ...
                    items: [
                        ...
                        {
                            type: "category",
                            label: "Common Component Properties",
                            items: [
                                "frontend/app-components-common-properties-conditional-rendering",
                                "frontend/app-components-common-properties-class",
                                "frontend/app-components-common-properties-draggable",
                                "frontend/app-components-common-properties-id",
                                "frontend/app-components-common-properties-language",
                                "frontend/app-components-common-properties-local-states",
                                "frontend/app-components-common-properties-title",
                                "frontend/app-components-common-properties-translate",
                            ],
                        },
                        {
                            type: "category",
                            label: "Common Component Style Attributes",
                            items: [
                                "frontend/app-components-common-style-attributes-align",
                                "frontend/app-components-common-style-attributes-align-content",
                                "frontend/app-components-common-style-attributes-align-items",
                                "frontend/app-components-common-style-attributes-align-self",
                                "frontend/app-components-common-style-attributes-background-color",
                                "frontend/app-components-common-style-attributes-background-source",
                                "frontend/app-components-common-style-attributes-border-color",
                                "frontend/app-components-common-style-attributes-border-radius",
                                "frontend/app-components-common-style-attributes-border-width",
                                "frontend/app-components-common-style-attributes-breaking",
                                "frontend/app-components-common-style-attributes-capitalize",
                                "frontend/app-components-common-style-attributes-children",
                                "frontend/app-components-common-style-attributes-color",
                                "frontend/app-components-common-style-attributes-cursor",
                                "frontend/app-components-common-style-attributes-decoration",
                                "frontend/app-components-common-style-attributes-direction",
                                "frontend/app-components-common-style-attributes-display",
                                "frontend/app-components-common-style-attributes-flex-basis",
                                "frontend/app-components-common-style-attributes-flex-grow",
                                "frontend/app-components-common-style-attributes-flex-shrink",
                                "frontend/app-components-common-style-attributes-font",
                                "frontend/app-components-common-style-attributes-grid-area",
                                "frontend/app-components-common-style-attributes-grid-auto-columns",
                                "frontend/app-components-common-style-attributes-grid-auto-flow",
                                "frontend/app-components-common-style-attributes-grid-auto-rows",
                                "frontend/app-components-common-style-attributes-grid-column",
                                "frontend/app-components-common-style-attributes-grid-column-gap",
                                "frontend/app-components-common-style-attributes-grid-column-end",
                                "frontend/app-components-common-style-attributes-grid-column-start",
                                "frontend/app-components-common-style-attributes-grid-gap",
                                "frontend/app-components-common-style-attributes-grid-row",
                                "frontend/app-components-common-style-attributes-grid-row-end",
                                "frontend/app-components-common-style-attributes-grid-row-gap",
                                "frontend/app-components-common-style-attributes-grid-row-start",
                                "frontend/app-components-common-style-attributes-grid-template",
                                "frontend/app-components-common-style-attributes-grid-template-areas",
                                "frontend/app-components-common-style-attributes-grid-template-columns",
                                "frontend/app-components-common-style-attributes-grid-template-rows",
                                "frontend/app-components-common-style-attributes-height",
                                "frontend/app-components-common-style-attributes-italicize",
                                "frontend/app-components-common-style-attributes-justify",
                                "frontend/app-components-common-style-attributes-justify-content",
                                "frontend/app-components-common-style-attributes-justify-items",
                                "frontend/app-components-common-style-attributes-justify-self",
                                "frontend/app-components-common-style-attributes-line-height",
                                "frontend/app-components-common-style-attributes-max-height",
                                "frontend/app-components-common-style-attributes-max-width",
                                "frontend/app-components-common-style-attributes-min-height",
                                "frontend/app-components-common-style-attributes-min-width",
                                "frontend/app-components-common-style-attributes-overflow",
                                "frontend/app-components-common-style-attributes-place-content",
                                "frontend/app-components-common-style-attributes-place-items",
                                "frontend/app-components-common-style-attributes-place-self",
                                "frontend/app-components-common-style-attributes-size",
                                "frontend/app-components-common-style-attributes-spacing-margin",
                                "frontend/app-components-common-style-attributes-spacing-padding",
                                //"frontend/app-components-common-style-attributes-style",
                                "frontend/app-components-common-style-attributes-text-align",
                                "frontend/app-components-common-style-attributes-weight",
                                "frontend/app-components-common-style-attributes-width",
                            ],
                        },
                        {
                            type: "category",
