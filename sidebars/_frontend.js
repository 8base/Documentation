                ...
                "frontend/app-components-component-groups",
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                "frontend/app-components-input-components-form-block",
                                "frontend/app-components-input-components-autocomplete",
                                "frontend/app-components-input-components-button",
                                "frontend/app-components-input-components-checkbox",
                                "frontend/app-components-input-components-date-picker",
                                "frontend/app-components-input-components-field-array",
                                "frontend/app-components-input-components-file-picker-8base",
                                "frontend/app-components-input-components-file-upload",
                                "frontend/app-components-input-components-multiselect",
                                "frontend/app-components-input-components-radio",
                                "frontend/app-components-input-components-radio-group",
                                "frontend/app-components-input-components-select",
                                "frontend/app-components-input-components-slider",
                                "frontend/app-components-input-components-switch",
                                "frontend/app-components-input-components-text-field",
                                "frontend/app-components-input-components-time-picker",
                                "frontend/app-components-input-components-toggle-button",
                                "frontend/app-components-input-components-toggle-button-group",
                            ],
                        },
                        {
                            type: "category",
