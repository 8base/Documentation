...
All required settings values for initializing the Auth module can be collected from an [Authentication Profile](/backend//app-services/authentication#authorization) created in the 8base console.
