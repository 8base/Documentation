...
const ParkingLot = {
  ...
  6: {
    ...
    items: [
      "frontend/app-components-create-and-editing-app-pages-introduction",
      "frontend/app-components-create-and-editing-app-pages-customizing-app-builder-components",
      "frontend/app-components-create-and-editing-app-pages-using-component-property-inputs",
      "frontend/app-components-create-and-editing-app-pages-customizing-styling-on-components",
      "frontend/app-components-create-and-editing-app-pages-setting-event-listeners-on-components",
      {
        type: "category",
