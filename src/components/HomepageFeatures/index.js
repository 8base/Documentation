    ...
    <>
      <Link href={URL} className={styles.doc_url}>
        <div className={styles.flex + " " + styles.home_url}>
          <div
            className={
              styles.flex + " " + styles.alcenter + " " + styles.url_left
            }
          >
            <SVG />

            <span className={styles.home_url_span}>{Text}</span>
          </div>
        ...
        <div className="row flex">
          <div className={"container " + styles.flex}>
            ...
            >
              <div
                className={
                  styles.flex + " " + styles.flex_col + " " + styles.header_wr
                }
              >
              ...
              <div className="flex">
                ...
                <Link
                  href="https://app.8base.com/auth/signup"
          ...
          <div className={styles.doc + " " + styles.flex}>
            ...
            <div className={styles.flex + " " + styles.home_url_cont}>
              ...
              >
                <div
                  className={
                    styles.flex + styles.flex_col + " " + styles.url_inner
                  }
                >
                  <HomeUrl
                    Text={"8base Backend"}
              ...
              >
                ...
                >
                  ...
                  <Link
                    href="/frontend/getting-started/introduction"
                    className={styles.join_academy + " " + styles.view_url}
                  >
                    <div className={styles.inner_join_button}>
          ...
          <div className={styles.flex + " " + styles.video_items_row}>
            {videos.items
              .slice(Math.max(videos.items.length - 4, 1))
              .map((data) => {
          ...
          <a
            ...
            className={styles.join_academy + " " + styles.join_left}
          >
            <div className={styles.inner_join_button}>Visit 8base Academy</div>
          </a>
          {/*visit 8base community */}
          <div className={styles.flex + " " + styles.join_card}>
            <div
              className={styles.flex + " " + styles.join_comp}
            ...
            <div className={styles.flex + " " + styles.join_comp_text}>
              <p className={styles.p_comm}>
                Hop on our community to get technical support and participate in
                forum topics.
              </p>
              <div className={styles.flex}>
                <button className={styles.join}>
                  <div className={styles.inner_join_button}>Join Now</div>
                </button>
              </div>
            </div>
          </div>
