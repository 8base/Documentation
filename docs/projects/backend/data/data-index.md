...
The [**Data Viewer**](8base-console-platform-tools-data-viewer.md) is a spreadsheet-like data view and management interface. You can access it on the ![data](../../_images/_icons/ic_data_table.svg) tab. You can create and edit table records, and sort table data. You can also import data from CSV files.
